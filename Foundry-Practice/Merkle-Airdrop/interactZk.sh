...
# Compile and deploy SomeToken contract
echo "Creating zkSync local node..."
#anvil-zksync
echo "Deploying token contract..."
TOKEN_ADDRESS=$(forge create src/SomeToken.sol:SomeToken --rpc-url http://127.0.0.1:8011 --private-key ${DEFAULT_ZKSYNC_LOCAL_KEY} --legacy --zksync | awk '/Deployed to:/ {print $3}' )
